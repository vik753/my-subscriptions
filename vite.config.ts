  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // Static pages (privacy policy, homepage for Google's OAuth review) and the Search
        // Console verification file are not app routes.
        navigateFallbackDenylist: [/\/(privacy|home|google[0-9a-f]+)\.html$/],
      },
    }),
  ],
  test: {
